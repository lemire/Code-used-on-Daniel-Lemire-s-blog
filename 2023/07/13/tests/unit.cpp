...
std::vector<uint8_t> expected = {
    ...
    TYPE_CAA,      TYPE_CDS,        TYPE_CDNSKEY, TYPE_CERT,       TYPE_CH,
    TYPE_CNAME,    TYPE_CS,         TYPE_CSYNC,   TYPE_DHCID,      TYPE_DLV,
    TYPE_DNAME,    TYPE_DNSKEY,     TYPE_DS,      TYPE_EUI48,      TYPE_EUI64,
    TYPE_GPOS,     TYPE_HINFO,      TYPE_HIP,     TYPE_HS,         TYPE_HTTPS,
    TYPE_IN,       TYPE_IPSECKEY,   TYPE_ISDN,    TYPE_KEY,        TYPE_KX,
