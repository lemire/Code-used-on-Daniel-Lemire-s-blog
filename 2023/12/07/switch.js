// this function is generated automatically from the script switch.py
    ...
    switch (len) {
      ...
      case 28:
        switch (s[13] ^ s[26]) {
          case 30:
          case 62:
            // check that the buffer is equal to access-control-allow-headers and return it if so
            if (
              (s[0] == 97 || s[0] == 65) &&
              (s[1] == 99 || s[1] == 67) &&
              (s[2] == 99 || s[2] == 67) &&
          ...
          case 8:
          case 40:
            // check that the buffer is equal to access-control-allow-methods and return it if so
            if (
              (s[0] == 97 || s[0] == 65) &&
              (s[1] == 99 || s[1] == 67) &&
              (s[2] == 99 || s[2] == 67) &&
          ...
          case 6:
          case 38:
            // check that the buffer is equal to cross-origin-embedder-policy and return it if so
            if (
              (s[0] == 99 || s[0] == 67) &&
              (s[1] == 114 || s[1] == 82) &&
              (s[2] == 111 || s[2] == 79) &&
          ...
          case 17:
          case 49:
            // check that the buffer is equal to cross-origin-resource-policy and return it if so
            if (
              (s[0] == 99 || s[0] == 67) &&
              (s[1] == 114 || s[1] == 82) &&
              (s[2] == 111 || s[2] == 79) &&
