...
set logscale x 2
# Plot the data from the file
plot 'intelicelake.txt' using 1:2 with lines lw 3 lc rgb "blue" title 'average', \
     'intelicelake.txt' using 1:3 with lines lw 1 lc rgb "red" title 'minimum', \
     'intelicelake.txt' using 1:4 with lines lw 1 lc rgb "orange" title 'maximum'
